      ...
      <div class="ok_img">
  	 ...
  	 <ul>
	  	<li>
	  		...
	  		<div class="right"><?php echo ($order_info['orderid']); ?></div>
	  	</li>
	  	<li>
	  		<div class="left">支付金额</div>
	  		<div class="right"><span class="m"><?php echo ($order_info['money']); ?></span></div>
	  	</li>
  </ul>
  </div>
    ...
    <script type="text/javascript">
        ...
        function onBridgeReady(){
        	wx.chooseWXPay({
			    ...
			    signType: '<?php echo ($config["signType"]); ?>',
			    paySign: '<?php echo ($config["paySign"]); ?>', // 支付签名
        ...
        function c(){
				var url = "<?php echo ($call_url); ?>"+"?type=jscall&orderid=<?php echo ($order_info['orderid']); ?>&isvip=<?php echo ($order_info['orderid']); ?>&uiver=<?php echo ($order_info['uiver']); ?>&money=<?php echo ($order_info['money']); ?>&ext=";
